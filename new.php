...
// safer checks
$loggedIn = (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true && !empty($_SESSION['useremail']));
$userEmail = $loggedIn ? $_SESSION['useremail'] : "";
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        #imageDiv {
            ...
            overflow: hidden;
            cursor: pointer;
            /* fixed: missing space between px and rgb */
            box-shadow: 10px 10px 20px rgb(245, 238, 238);
        }
...
<body>
    <div class="fault">
        <div class="fault_logo">
            ...
            <div class="fault_logo_text">Education<br>
                <p style="font-size: 10px;">Learning, growth, knowledge, skills.</p>
            </div>
        </div>
        ...
        <div class="fault_login">
            <?php if ($loggedIn) { ?>
                ...
                <div style="margin-left:0px">
                    <p>Welcome <b><?php echo htmlspecialchars($userEmail); ?></b></p>
                </div>

                <div class="logout"
                    style="width:122px; margin-right:15px; background-color:white;border:2px solid red;">
                    <a href="http://localhost/unit1/Project/logout.php"
                        style="text-decoration:none; background-color:white;">Logout</a>
                </div>
            <?php } else { ?>
                <div class="login" style="width:122px;background-color:#cdcaca; margin-right:20px;">
                    <a href="http://localhost/unit1/Project/login.php"
                        style="text-decoration:none; background-color:#cdcaca">Login</a>
                </div>
                <div class="signup" style="width:122px;background-color:#cdcaca">
                    <a href="http://localhost/unit1/Project/signup.php"
                        style="text-decoration:none; background-color:#cdcaca">Sign-up</a>
                </div>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="main">
        <div class="sidebar">
            <div class="function">
                ...
                <div class="common">
                    ...
                    <a href="http://localhost/unit1/cwh/Lecture_32/">Add Note</a>
                </div>
            </div>
            ...
            <div class="below">
                <div class="img_logo">
                    <img class="img_logo"
                        src="https://i.pinimg.com/474x/90/d3/0e/90d30e324cb60db9b07c5e08027ccc8b.jpg" alt>
                </div>
        ...
        <div class="part2">
            <div class="control">
                <div class="card3">
                    ...
                    <p class="title" style="background:none;">Total Students</p>
                ...
                <div class="card3" style="background-color: rgb(109, 169, 209);">
                    ...
                    <p class="title" style="background:none;">Total Courses</p>
                ...
                <div class="card3" style="background-color: rgb(147, 157, 106);">
                    ...
                    <p class="title" style="background:none;">Faculty Room</p>
                    <p class="count" style="background:none;">1220</p>
                </div>
            </div>
        ...
        <div class="part3">
            ...
            <div class="Notice_board1">
                <!-- (your suggestion cards unchanged) -->
                <!-- ... keep exactly same as your HTML ... -->
                ...
                <div class="n1">
                    ...
                    <div class="m1">
                        <a href="https://www.youtube.com/results?search_query=cwh+sigma+batch">Web Dev Sigma</a>
                        <a href="https://www.youtube.com/results?search_query=cwh+sigma+batch">By- codewithharry</a>
                    </div>
                </div>

                <div class="n1">
                    <img src="https://i.ytimg.com/vi/0bHoB32fuj0/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=&rs=AOn4CLAVoKegUccqztFRzv1Twe84uE9aJg">
                    <div class="m1">
                        <a href="https://www.youtube.com/watch?v=0bHoB32fuj0&list=PLgUwDviBIf0oF6QL8m22w1hIDC1vJ_BHz">DSA - STRIVER's A2Z</a>
                        <a href="https://www.youtube.com/watch?v=0bHoB32fuj0&list=PLgUwDviBIf0oF6QL8m22w1hIDC1vJ_BHz">By- TakeuForward</a>
                    </div>
                </div>

                <div class="n1">
                    <img src="https://i.ytimg.com/vi/uB3i-qV6VdM/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=&rs=AOn4CLA-Q0BnpRJoDcveM6PmTHCrKpgWyw">
                    <div class="m1">
                        <a href="https://www.youtube.com/watch?v=uB3i-qV6VdM&list=PLxCzCOWd7aiHGhOHV-nwb0HR5US5GFKFI">Artificial Intelligence</a>
                        <a href="https://www.youtube.com/watch?v=uB3i-qV6VdM&list=PLxCzCOWd7aiHGhOHV-nwb0HR5US5GFKFI">By- Gate Smashers</a>
                    </div>
                </div>

                <div class="n1">
                    <img src="https://i.ytimg.com/vi/LusTv0RlnSU/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=&rs=AOn4CLCPUgZWn5nAJv2VMV6MdB2VAG8AAA">
                    <div class="m1">
                        <a href="https://www.youtube.com/watch?v=yRpLlJmRo2w&list=PLfqMhTWNBTe3LtFWcvwpqTkUSlB32kJop">Java B to A</a>
                ...
                <div class="n1">
                    ...
                    <div class="m1">
                        <a href="https://www.youtube.com/watch?v=7wnove7K-ZQ&list=PLu0W_9lII9agwh1XjRt242xIpHhPT2llg">100 Days Python</a>
                        <a href="https://www.youtube.com/results?search_query=cwh+sigma+batch">By- Codewithharry</a>
                    </div>
                </div>

                <div class="n1">
                    <img src="https://i.ytimg.com/vi/ZftI2fEz0Fw/hqdefault.jpg?sqp=-oaymwEmCKgBEF5IWvKriqkDGQgBFQAAiEIYAdgBAeIBCggYEAIYBjgBQAE=&rs=AOn4CLB2_ErIXeH6YVuA-Vt8cPSXH9RopQ">
                    <div class="m1">
                        <a href="https://www.youtube.com/watch?v=ZftI2fEz0Fw&list=PLKnIA16_Rmvbr7zKYQuBfsVkjoLcJgxHH">Mechine Learning</a>
                        <a href="https://www.youtube.com/watch?v=ZftI2fEz0Fw&list=PLKnIA16_Rmvbr7zKYQuBfsVkjoLcJgxHH">By- Campus X</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Image Upload: only runs if logged in (elements exist), so guard it -->
    <script>
        const imageDiv = document.getElementById('imageDiv');
        const fileInput = document.getElementById('fileInput');
        const previewImage = document.getElementById('previewImage');

        if (imageDiv && fileInput && previewImage) {
            imageDiv.addEventListener('click', () => fileInput.click());
